...
// 1. Viewport Settings: Mobile par zoom issues rokn
...
export const metadata: Metadata = {
  ...
  keywords: [ "lex pro ai" ,"lex pro ai","lex pro ai","Lex pro ai","Pakistan Law", "Legal AI", "PPC Pakistan", "CrPC", "Constitution of Pakistan", "Lex Pro", "Legal Advisor AI"],
