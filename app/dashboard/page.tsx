...
const PromptCard = ({ p, isDark, onClick }: any) => (
  ...
  >
    <div
      className={`w-10 h-10 md:w-12 md:h-12 rounded-xl md:rounded-2xl flex items-center justify-center shrink-0 transition-all ${
    ...
    <div className="flex flex-col overflow-hidden w-full">
      ...
      <p
        className={`text-[11px] md:text-[12px] font-medium line-clamp-2 leading-snug ${
    ...
    <div
      className={`h-[100dvh] w-full transition-all duration-700 flex flex-col font-sans overflow-hidden relative ${
        isDark
          ...
          : "bg-gradient-to-br from-[#c9c9f1] to-[#ffd5f4] text-slate-900"
      }`}
    >
      ...
      <div className="fixed top-6 left-6 md:top-10 md:left-10 flex items-center gap-3 z-[100] pointer-events-none">
        ...
        <span
          className={`font-bold text-[14px] md:text-[16px] tracking-tight transition-colors ${
      ...
      >
        <div
          className={`px-4 py-2 rounded-xl flex items-center gap-2 shadow-lg backdrop-blur-xl border transition-all ${
            isDark
              ? "bg-white/5 border-white/10 hover:bg-white/10 text-white"
              : "bg-white/40 border-white/20 text-slate-800 hover:bg-white/60"
          }`}
        >
          <UserCircle2 size={18} />
          ...
          {messages.length === 0 ? (
            ...
            >
              <motion.div
                ...
                className={`w-12 h-12 md:w-12 md:h-12 rounded-[22px] md:rounded-[28px] flex items-center justify-center shadow-2xl mb-6 md:mb-1 transition-all ${
                  isDark ? "bg-white text-black" : "bg-[#1a1a1a] text-white"
                }`}
              >
                <Sparkles size={20} />
              ...
              <h1
                className={`text-3xl md:text-5xl font-bold tracking-tight mb-2 md:mb-2 ${
              ...
              <h2
                className={`text-lg md:text-2xl font-semibold mb-2 md:mb-2 ${
                  isDark ? "text-slate-400" : "text-slate-500"
                }`}
              >
              ...
              {messages.map((m, i) => (
                ...
                >
                  <div className="shrink-0">
                    <div
                      className={`w-8 h-8 md:w-10 md:h-10 rounded-full flex items-center justify-center border shadow-sm transition-all ${
                        m.role === "user"
                          ? isDark
                  ...
                  >
                    <div
                      className={`relative text-[14px] md:text-[15px] font-medium leading-relaxed p-4 md:p-5 rounded-[20px] md:rounded-[22px] shadow-sm transition-all ${
                        m.role === "user"
                          ? isDark
      ...
      <style jsx global>{`
        ...
        html {
          ...
          position: fixed;
          width: 100%;
          background: ${isDark ? "#0a0a0a" : "#ededf8"};
