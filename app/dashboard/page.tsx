          ...
          {messages.length === 0 ? (
            ...
            >
              <motion.div
                ...
                className={`w-12 h-12 md:w-12 md:h-12 rounded-[22px] md:rounded-[28px] flex items-center justify-center shadow-2xl mb-6 md:mb-1 transition-all ${isDark ? "bg-white text-black" : "bg-[#1a1a1a] text-white"}`}
              >
                <Sparkles size={20} />
              </motion.div>
